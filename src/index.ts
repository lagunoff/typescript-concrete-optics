 ...
 */
export function compose<A, B, C>(left: Lens <A, B>, right: Lens <B, C>): Lens <A, C>;
...
export function compose<A, B, C>(left: Iso  <A, B>, right: Lens <B, C>): Lens <A, C>;
export function compose<A, B, C>(left: Lens <A, B>, right: Iso  <B, C>): Lens <A, C>;
export function compose<A, B, C>(left: Iso  <A, B>, right: Prism<B, C>): Prism<A, C>;
export function compose<A, B, C>(left: Prism<A, B>, right: Iso  <B, C>): Prism<A, C>;
